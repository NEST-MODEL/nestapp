...
.loader-bar{
  width:160px; height:4px; background:var(--black-3); border-radius:4px; overflow:hidden; position:relative;
}
.loader-bar::after{
  content:''; position:absolute; inset:0; width:40%; background:var(--yellow);
  border-radius:4px; animation:loaderSweep 1s var(--ease) infinite;
}
